  ...
  const galleryItems = [
    {
      ...
      title: "FEB-14",
      description:
        "Surprise your partner with your blessing on time for upcoming valentines.",
    ...
    },
    {
      ...
      title: "Accuracy",
      description:
        "Secure and accurate delivery times through a computerized system. See How it works >>>",
    ...
    },
    {
      ...
      title: "Packages",
      description:
        "Enjoy our special delivery with special packages and you'll see unexpected things. Check on HomePage",
    ...
    },
    {
      ...
      title: "Secure ",
      description:
        "No more waiting on mails to deliver and missing on mails and more secure with further details ",
    ...
    },
    {
      ...
      title: "Free",
      description:
        "Be our respected loyal customer with gaining more points on the account and have a chance to win 2 months free",
            ...
            <div className="bg-white rounded-md overflow-hidden">
              ...
              <div className="p-6 flex flex-col justify-between">
                <div className="bg-black bg-opacity-10 rounded-md p-6 transition-transform transform-gpu hover:scale-110 hover:bg-rose-500">
                  ...
                  <p className="text-gray-600 mb-4 font-bold hover:text-white">
                    {item.description}
                  </p>
                </div>
