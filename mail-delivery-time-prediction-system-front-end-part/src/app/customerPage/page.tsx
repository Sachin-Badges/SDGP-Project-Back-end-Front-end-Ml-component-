    ...
    <RootLayout hideNavbar={true}>
      ...
      <section className="lg:py-16">
        <div className="lg:flex lg:justify-between">
          <div className="hidden lg:block">
            <Link href="/" passHref>
              <a className="px-5 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-white text-black text-lg border border-black hover:bg-rose-500 hover:text-white transition-all">
                About Us
              </a>
            </Link>
            <Link href="/" passHref>
              <a className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3 text-lg">
                <span className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-3">
                  Back to Home
                </span>
              </a>
          ...
          <div className="col-span-7 place-self-center">
            <h1 className="text-white mb-4 text-2xl sm:text-4xl lg:text-6xl lg:leading-normal font-extrabold">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600 block text-5xl sm:text-7xl lg:text-7xl lg:leading-normal">
                Hello There!
              </span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600 block text-4xl sm:text-7xl lg:text-5xl lg:leading-normal">
                Welcome to 
