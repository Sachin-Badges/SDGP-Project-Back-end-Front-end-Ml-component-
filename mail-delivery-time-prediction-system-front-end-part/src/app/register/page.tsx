...
//         color="red"
//       > */}
//       <fieldset className={`bg-white bg-opacity-5 border border-silver p-4 rounded-lg ${styles.Form_Field}`}>
//         {" "}
//         <form className="Reg_form" onSubmit={handleSubmit}>
//           <br />
//           <br />
...
//                   placeholder="Enter your username"
//                   name="Username"
//                   className={`bg-white bg-opacity-5 border border-silver rounded-lg px-3 py-2 mb-2 ${styles.input_box}`}
// />
...
//                 type="text"
//                 name="Customer_Latitude"
//                 className={`bg-white bg-opacity-5 border border-silver rounded-lg px-3 py-2 mb-2 ${styles.input_box}`}></input>
//             </label>
//             <br />
//             <br />
//             <br />
